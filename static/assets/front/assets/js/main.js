...
(function ($) {
  ...
  if (_mainJS) {
    ...
    if (document.querySelector('[data-parallax]')) {
      ...
      parallax_js.src = '/static/assets/front/assets/plugins/parallax/parallax.js';
    ...
    if ((document.querySelector('[data-carousel="owl-carousel"]')) || (document.getElementsByClassName('owl-carousel'))) {
      ...
      owl_carousel_js.src = '/static/assets/front/assets/plugins/owl.carousel/owl.carousel.min.js';
