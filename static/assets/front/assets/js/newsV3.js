document.getElementById("news-content").innerHTML = '<div style="margin: 0 auto;"><img src="/static/assets/front/assets/img/preloader.svg" /></div>';
...
axios
    ...
    .then(function (response) {
        ...
        <div class="col-lg-8">
        <div class="text-gray">
            <h5 class="text-uppercase fw-600"><a href="/news/${element.id}/">${element.title.rendered}</a></h5>
