...
<head>
  <title>Descubre | ROBO-ONE Latinoamérica</title>
...
<body class="page-body">
  ...
  <header id="header" class="header h-fullscreen__page text-light">
    <div class="media-container parallax-window" data-parallax="scroll" data-image-src="assets/img/bg/bg-2.jpg"
      data-overlay="6"></div>
  ...
  <main class="main-content">
    ...
    <!-- Start Content Area -->
    <section class="content-section gradient-lg">
      <div class="container">
        <div class="row gutters-y align-items-center">
          ...
          <div class="col-lg-6 ml-lg--8 rounded bg-dark text-light shadow-lg-3 py-7 px-lg-7 py-lg-6">
            ...
            <hr class="w-10 border-top-2 my-6 my-xl-7 ml-0 border-warning">
            <p class="lead-1">Facilitar la incorporación de conocimiento avanzado en robótica bípeda y tecnologías de
              vanguardia, fomentando el desarrollo de la robótica e industria 4.0, mediante una competencia
              internacional pionera en el mundo, muy entretenida y desafiante.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Start Content Area -->
    <section class="content-section text-center text-light parallax-window position-relative" data-parallax="scroll"
      data-image-src="assets/img/bg/bg-4.jpg">
      <div class="overlay bg-dark_A-80 pe-n"></div>
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2 class="mb-6">Objetivos</h2>
            ...
            <p class="lead-1">Masificar el conocimiento tecnológico avanzado en Chile. Inspirar a todo tipo de
              ...
              Tics, mediante la ejecución de una competencia desafiante en tecnología y habilidades.</p>
            <p class="lead-1">Implementar una base de conocimiento en el país, permitiendo su disponibilidad de acceso
              y uso. Crear una liga nacional de robótica bípeda para la incorporación y detección de jóvenes
              talentos.</p>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-6 mx-auto">
            <div class="text-light">
              <h2 class="mb-3">Inscribe tu equipo!</h2>
              <p class="mb-0 lead-1">Estas a punto de comenzar una gran aventura desafiante, innovadora y con mucho
                potencial tecnológico.</p>
              <br>
              <a href="https://docs.google.com/forms/d/1UfHcaDh6Mchan0FH7g1oT1oJ4CJrB1C6-kHsw1evslU/edit"
                class="btn btn-lg btn-round btn-light mb-2">Inscripciones</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="content-section text-light parallax-window position-relative" data-parallax="scroll"
      ...
      <div class="container">
        <div class="row gutters-y align-items-center">
          <div class="col-lg-6 mb-4 mb-lg-0 ml-auto">
            <div class="ar-4_3 bs-c bp-c br-n rounded"
              style="background-image: url(assets/img/bg/douc-uc-san-carlos-apoquindo.jpg)"></div>
          </div>
          <div class="col-lg-6 ml-lg--8 rounded bg-dark text-light shadow-lg-3 py-7 px-lg-7 py-lg-6">
            <h3 class="mb-4">Lugar de competencia</h3>
            <hr class="w-10 border-top-2 my-6 my-xl-7 ml-0 border-warning">
            <ul>
              <li>Duoc UC San Carlos de Apoquindo. <a href="https://goo.gl/maps/D1Ad9CL2UqS7ADfcA"
                  target="_blank">Camino El Alba 12881, Las Condes.</a></li>
              <li>Sábado 21 de Diciembre de 09:00 hrs. - 17:30 hrs.</li>
              <li>Metro los Dominicos (Línea 1), Santiago.</li>
              <li>Entrada con invitación.</li>
            </ul>
            <a href="http://ia13.cl/streaming" class="btn btn-sm btn-round btn-light mb-2 float-right"
              target="_blank"><i class="fas fa-play-circle"></i> Transmisión en vivo</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-fluid">
        <div class="row py-2 py-lg-1">
          <div class="col-md-6 col-lg d-flex pl-lg-0 pr-lg-1 mb-4 mb-lg-0">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/3.jpg);">
                </figure>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg d-flex px-lg-1 mb-4 mb-lg-0">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/11.jpg);">
                </figure>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg d-flex px-lg-1 mb-4 mb-md-0">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/6.jpg);">
                </figure>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg d-flex pr-lg-0 pl-lg-1">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/5.jpg);">
                </figure>
              </div>
            </div>
          </div>
        ...
        <div class="row py-2 py-lg-1">
          <div class="col-md mb-4 mb-md-0 d-flex pr-lg-1 pl-lg-0">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/4.jpg);">
                </figure>
              </div>
            </div>
          </div>
          <div class="col-md mb-4 mb-md-0 d-flex px-lg-1">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/7.jpg);">
                </figure>
              </div>
            </div>
          </div>
          <div class="col-md d-flex pl-lg-1 pr-lg-0">
            <div class="tile d-flex px-0">
              <div class="tile">
                <figure class="h-100 ar-8_5 bs-c br-n bp-c" style="background-image: url(assets/img/thumb/12.jpg);">
                </figure>
              </div>
            </div>
          </div>
